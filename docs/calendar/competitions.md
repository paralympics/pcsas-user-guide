...
| **Responsible IF**                                       | text field, unmodifiable | Owner of the competition. If owner is not UCI, main competition data and sports-specific details except Cycling is read-only.                                                                                                                |
